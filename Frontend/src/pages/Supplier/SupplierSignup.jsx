...
const SupplierSignup = () => {
  return (
    <div>
      {/* Scripts and styles should be included in index.html */}
        ...
        <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{ maxWidth: '1000px' }}>
          <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  ...
                  <div className="flex">
                    ...
                    <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="999999999" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  <label htmlFor="" className="text-xs font-semibold px-1">What are you trying to Sell</label>
                  
                    <div><p>Car</p> <p>Bike</p> <p>Books</p> <p>Household</p></div>
              ...
              <button className="block w-full bg-indigo-500 hover:bg-indigo-600 focus:bg-indigo-700 text-white uppercase text-lg rounded-lg py-3">Register</button>
            </div>
          </div>
        </div>
      </div>
