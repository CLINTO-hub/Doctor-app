        ...
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
          <div>
            <div className='lg:w-[570px]'>
              <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[40px] md leading-[70px] '>We help patients live a healthy, longer life</h1>
    ...
    <div className='container'>
      <div className='lg:w-[470px] mx-auto'>
        ...
        <p className='text__para text-center'>
          World-class care for evey one.Our health care offers unmatched expert health care. 
        </p>
      </div>

      <div className='flex flex-wrap items-center justify-between flex-col md:flex-row gap-5 lag:gap-[30px] mt-[30px] lg:mt-[55px]'>
        ...
        <div className='py-[30px] px-5'>
          ...
          <div className="text-center">
            ...
            <p className="text-[16px] leading-7 text-textColor font-[400]">
              Our healthcare offers unmatched expert care.
            </p>
            <p className="text-[16px] leading-7 text-textColor font-[400]">
...
<Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
        ...
        <div className='py-[30px] px-5'>
          <div className='flex items-center justify-center '><img src={icon02} alt=""></img></div>
...
<Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
        ...
        <div className='py-[30px] px-5'>
          <div className='flex items-center justify-center '><img src={icon03} alt=""></img></div>
    ...
    <section>
      <div className='container'>
        <div className='xl:w-[470px] mx-auto'>
          ...
          <p className='text__para text-center'>
            World-Class  care for every patients. Our health System offers unmatched,expert health care 
          </p>
        </div>
  ...
  <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
    <div className='flex flex-col gap-[6px] lg:gap-3'>
      ...
      <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'>
        ...
        <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor'>Wayane Collins</h4>
      </div>
