            ...
            <div className='flex items-center gap-5'>
              ...
              <div>
                <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>
                  <span className='text-headingColor'>Surgeon</span>
                  ...
                  <p className='text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]'>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rerum ducimus amet deserunt ipsam iusto a ea! Quis non numquam at a architecto, aperiam dolores blanditiis cum nam.
                  </p>
                </span>
              </div>
            </div>
