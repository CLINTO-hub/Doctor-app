...
const FeedbackForm = () => {
  ...
  return <form action=''> 
    ...
    <div className='mt-[30px]'>
        ...
        <textarea className='border border-solid border-[#0066ff34] focus:outline outline-primaryColor w-full px-4 py-3 rounded-md' rows='5' placeholder = 'Write the Masssage' onChange={(e)=>setReviewText(e.target.value)}>
